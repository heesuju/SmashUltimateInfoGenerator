...
class ApiEndpoints:
    ...
    GAMEBANANA_MOD_NEW_LIST_BY_USER = "https://api.gamebanana.com/Core/List/New?itemtype=Mod&gameid=6498&include_updated=1&page={page}&userid={user}"
    GAMEBANANA_MOD_DATA = "https://gamebanana.com/apiv4/Mod/{id}"
    GAMEBANANA_USER_SEARCH = "https://api.gamebanana.com/Core/List/Like?itemtype=Member&field=name&match={name}"
