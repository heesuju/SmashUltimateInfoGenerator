...
class NavigationMenuIcon(Enum):
    PREVIEW = "assets/icons/menu/details_32.svg"
    CONFIG = "assets/icons/menu/config_32.svg"
    FILTER = "assets/icons/menu/filter_32.svg"
    SORT = "assets/icons/menu/sort_32.svg"
    EDIT = "assets/icons/menu/edit_32.svg"
    BATCH = "assets/icons/menu/batch_32.svg"
    WORKSPACE = "assets/icons/menu/workspace_32.svg"
    DOWNLOAD = "assets/icons/menu/download_32.svg"
    NONE = ""

class ButtonIcons(Enum):
    EDIT = "assets/icons/buttons/edit_16.png"
    GRID = "assets/icons/buttons/grid_16.svg"
    LIST = "assets/icons/buttons/list_16.svg"
    ...
    ENABLE = "assets/icons/buttons/on_16.svg"
    DISABLE = "assets/icons/buttons/off_16.svg"
    MENU = "assets/icons/buttons/menu_16.png"
    SORT_ASC = "assets/icons/buttons/sort_asc_16.svg"
    SORT_DESC = "assets/icons/buttons/sort_desc_16.svg"
    WEB = "assets/icons/buttons/web_16.svg"
    DOWNLOAD = "assets/icons/buttons/download_16.svg"
    BATCH_GENERATE = "assets/icons/buttons/generate_16.svg"
    BATCH_ENABLE = "assets/icons/buttons/check_16.svg"
    BATCH_DISABLE = "assets/icons/buttons/block_16.svg"
    BATCH_REMOVE = "assets/icons/buttons/trash_16.svg"
    ADD = "assets/icons/buttons/add_16.svg"
    DESELECT = "assets/icons/buttons/deselect_16.svg"
    MORE = "assets/icons/buttons/more_16.svg"
    REFRESH = "assets/icons/buttons/refresh_16.svg"
    SEARCH = "assets/icons/buttons/search_16.svg"
    CLEAR = "assets/icons/buttons/clear_16.svg"
