from PyQt6.QtWidgets import (
    QWidget, QLabel, QLineEdit, QComboBox, QVBoxLayout, QApplication
)
...
if __name__ == "__main__":
    ...
    # Line edit with top label
    line_edit = QLineEdit()
    top_line = TopLabelWrapper(line_edit, "Username", height=50, font_size=10, label_color="blue")
    layout.addWidget(top_line)

    # Combo box with top label
    combo = QComboBox()
    combo.addItems(["Books", "Electronics", "Clothing"])
    top_combo = TopLabelWrapper(combo, "Category", height=50, font_size=10, label_color="green")
    layout.addWidget(top_combo)
